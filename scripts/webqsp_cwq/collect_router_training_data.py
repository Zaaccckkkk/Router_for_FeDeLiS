...
RAW_DATA_DIR = ROUTER_ROOT / "raw_data" / "webqsp_cwq"

DEFAULT_INPUTS = (
    RAW_DATA_DIR / "RoG-webqsp_train_router_labels.jsonl",
    RAW_DATA_DIR / "RoG-cwq_new.jsonl",
)
DEFAULT_CORRECT_LINES = RAW_DATA_DIR / "correct_router_lines.jsonl"
DEFAULT_CLEAN_DATA = RAW_DATA_DIR / "clean_router_training_data.jsonl"
